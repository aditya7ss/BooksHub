...
import LibraryIllustration from "../..//Assets/Images/Book_Covers/clip.mp4"
import './Home.css'
      ...
      if(token)
      {
          ...
          else
          {
              (async function getUpdatedWishlistAndCart()
              {
                  ...
                  "https://http://bookztron-server.vercel.app/api/user",
                  {
                      headers:
                      {
  ...
  return (
    <div className='home-component-container'>
      <div className='home-page-img-container'>
        <video className="home-page-background-img" src={LibraryIllustration} muted type="video/mp4" alt="Library Illustration"/>
        <div className="homeContent container">
          <div className="textDiv">
            <span className="largetext">
              <h1>Discover</h1>
              <h2>amazing Book's</h2>
            </span>
            <span className="smalltext">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium quibusdam,
              sunt nostrum ipsam facere dolore recusandae quia quam minima. Omnis, dolores voluptas
              corrupti quibusdam atque recusandae quae nam doloribus suscipit.
            </span>
          </div>
          </div>
      </div>
